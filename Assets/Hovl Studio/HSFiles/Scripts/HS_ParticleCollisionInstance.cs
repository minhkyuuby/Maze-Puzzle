...
public class HS_ParticleCollisionInstance : MonoBehaviour
{
    ...
    {      
        ...
        // If the collided object is a ghost, mark it for destruction after spawning impact effects.
        EnemyGhostController ghost = other ? other.GetComponent<EnemyGhostController>() : null;
        bool ghostDestroyed = false;
        for (int i = 0; i < numCollisionEvents; i++)
        {
            ...
            if (ghost && !ghostDestroyed)
            {
                // Simple kill: destroy the ghost GameObject.
